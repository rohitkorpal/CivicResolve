...
| Feature | Description |
| :--- | :--- |
| **Dual-Theme UI** | Features "Moonlight Dark Mode" for night-safe field inspections. |
| **Gemini AI Engine** | Synthesizes a structured 4-step physical mitigation checklist for every report. |
| **Eco-Social Forecasts** | Estimates saved gallons of water, kilograms of CO2 offset, and walkability gains. |
| **Gamification** | A reputation engine rewards citizens for completing micro-restoration tasks. |
| **Dispatch Hub** | A municipal dashboard with browser-native Web Audio synthesized alerts. |
